...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  void initState() {
    super.initState();
    // ✅ استخدم addPostFrameCallback عشان نضمن إن الـ BlocProvider جاهز
  ...
  // ── Grid ──────────────────────────────────────────
  Widget _buildGrid(BuildContext context, ProductsSuccessState state) {
        ...
        builder: (context, favState) {
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildProductCard(context, product: product, isFav: isFav);
            },
          );
        },
      ),
